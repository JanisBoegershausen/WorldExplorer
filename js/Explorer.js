...
function LoadAllEntities() {
  ...
  var requestUrl = "https://api.github.com/repos/JanisBoegershausen/JanisBoegershausen.github.io/git/trees/master?recursive=1";
  ...
  fileListRequest.onreadystatechange = function () {
    if (fileListRequest.readyState === 4 && fileListRequest.status === 200) {
      ...
      entityJsonFiles.forEach((entityJsonFile) => {
        ...
        entityJsonRequest.open("GET", "https://janisboegershausen.github.io/" + entityJsonFile.path, true);
